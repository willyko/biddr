...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { details: @auction.details, ends_on: @auction.ends_on, reserve_price: @auction.reserve_price, title: @auction.title }
    end
  ...
  test "should update auction" do
    patch :update, id: @auction, auction: { details: @auction.details, ends_on: @auction.ends_on, reserve_price: @auction.reserve_price, title: @auction.title }
    assert_redirected_to auction_path(assigns(:auction))
  end
